...
import { CardContainer, ImageWrapper, ImageContainer, DetailsWrapper, Column, DonateButton, Row} from './DonorStyles'
...
const RequestCard: React.FC<RequestCardProp> = ({details}) => {
    ...
    const {requestType, requestedBy, description, requestId} = details
        ...
        <CardContainer>
            ...
            <DetailsWrapper>
               ...
               <>
                    ...
                    <div 
                        style={{display: 'flex', width: '80%', margin: '30px auto'
